...
public interface DataTypeRegistry {
     ...
     * As a fallback may also try to resolve the converter with only the name in the given set of default Camel converters
    ...
    /**
     * Find data type for given data type name. Just searches the set of default Camel converter implementations registered in
     * this registry.
     *
     * @param  name the data type converter name.
     * @return
