 ...
 * and searching for a file of the URI scheme name in the <b>META-INF/services/org/apache/camel/datatype/converter/</b>
 * directory
 * on the classpath.
 */
public class DefaultDataTypeConverterResolver implements DataTypeConverterResolver {
    ...
    public Optional<DataTypeConverter> resolve(String scheme, String name, CamelContext context) {
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug("Resolving data type converter {} via: {}{}", converterName, DATA_TYPE_CONVERTER_RESOURCE_PATH,
                    converterName);
        }
