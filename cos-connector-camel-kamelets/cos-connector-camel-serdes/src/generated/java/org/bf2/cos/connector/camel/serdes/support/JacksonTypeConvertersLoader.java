...
public final class JacksonTypeConvertersLoader implements TypeConverterLoader, CamelContextAware {
    ...
    private volatile org.bf2.cos.connector.camel.serdes.support.JacksonTypeConverters jacksonTypeConverters;
    private org.bf2.cos.connector.camel.serdes.support.JacksonTypeConverters getJacksonTypeConverters() {
        if (jacksonTypeConverters == null) {
            jacksonTypeConverters = new org.bf2.cos.connector.camel.serdes.support.JacksonTypeConverters();
