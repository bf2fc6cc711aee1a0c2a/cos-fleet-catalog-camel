...
All original contributions to cos-fleet-cataglog-camel are licensed under the
...
All submissions, including submissions by project members, need to be reviewed by a cos-fleet-cataglog-camel committers before being merged.
...
### Continuous Integration
 ...
 cos-fleet-cataglog-camel project CI is based on GitHub Actions, which means that everyone has the ability to automatically execute CI in their forks as part of the process of making changes. We ask that all non-trivial changes go through this process, so that the contributor gets immediate feedback, while at the same time keeping our CI fast and healthy for everyone.
